# Jogo de "Avatar: A Lenda de Aang" sobre treinamento de manipulacao elemental.
# O usuario constantemente informa um elemento e atribui-lhe valor arbitrario, e o elemento oposto tem seu numero subtraido pela metade do valor informado.
# Os pares de elementos opostos são AGUA / FOGO e TERRA / AR.
# Ao informar 'X' como elemento, o programa se encerra, mostrando os resultados numericos finais de cada elemento.
